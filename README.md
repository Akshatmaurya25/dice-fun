...
dice.fun is a **decentralized streaming platform** built on Kadena blockchain that puts creators first. No cap 🧢
...
- **Zero Gas Fees**: Because paying to get paid is ridiculous
- **Instant Transactions**: Lightning-fast settlements
- **Scalable AF**: Handles millions of users without breaking a sweat
- **Eco-Friendly**: Green blockchain > energy-hungry alternatives
- **Proof of Work Security**: Battle-tested, not experimental
...
- **Micro-Influencer Friendly**: We respect the grind, regardless of follower count
- **Filecoin-Powered Storage**: ALL uploads (videos, images, profile pics) stored on decentralized Filecoin network
- **Permanent Content**: Your media lives forever on IPFS - no platform can delete it
...
- **Community Driven**: Decentralized governance coming soon

## 🏗️ Tech Stack (For the Devs)

- **Frontend**: Next.js 15, React 19, TypeScript, Tailwind CSS
- **Blockchain**: Kadena Chainweb EVM Testnet
- **Storage**: Filecoin (via Synapse SDK) - **ALL user uploads stored here**
- **Content Addressing**: IPFS with unique PieceCIDs for every file
...
- **Anyone** who believes in decentralized creator economy
...
1. **Connect MetaMask** to Kadena testnet
2. **Verify identity** with Self Protocol
3. **Start streaming** and earning immediately
4. **Receive tips** in real-time KDA

## 🛣️ Roadmap

- [x] **MVP Launch**: Basic streaming + tipping
- [x] **Filecoin Integration**: Decentralized storage
- [x] **Self Protocol**: ZK identity verification
- [ ] **Mobile App**: iOS/Android native apps
- [ ] **Creator Tokens**: Monetize your community
- [ ] **DAO Governance**: Community-owned platform
- [ ] **Cross-Chain**: Expand beyond Kadena

## 🤝 Contributing

We're open source because transparency > gatekeeping.
...
MIT License - Because we believe in open innovation.
